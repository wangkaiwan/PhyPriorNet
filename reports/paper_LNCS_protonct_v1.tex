...
\begin{figure}[t]\centering\includegraphics[width=.88\linewidth]{model_arch.pdf}
...
\begin{figure}[t]\centering\includegraphics[width=.82\linewidth]{figS_residual_protonct_abdomen.png}
...
\begin{figure}[t]\centering\includegraphics[width=.82\linewidth]{figS_residual_protonct_lung.png}
...
\begin{figure}[t]\centering\includegraphics[width=.55\linewidth]{fig_deploy_protonct.pdf}
...
\begin{figure}[t]\centering\includegraphics[width=.92\linewidth]{fig_qual_protonct.png}
